...
public class GuiController {
	...
	public void GUIField(Field[] fields) {
		...
		desktopFields[10] = new desktop_fields.Street.Builder().setTitle(fields[11].getFieldName())
				.setSubText("Price: " + ((Territory) fields[11]).getPrice())
				.setRent("Rent: " + ((Territory) fields[11]).getRent()).setBgColor(Color.RED).build();

		// Refuge

		desktopFields[11] = new desktop_fields.Refuge.Builder().setTitle(fields[12].getFieldName())
				.setSubText("Reward: " + ((Refuge) fields[12]).getBonus()).setBgColor(Color.white)
				.setPicture("images/wcity.png").build();

		desktopFields[12] = new desktop_fields.Refuge.Builder().setTitle(fields[13].getFieldName())
