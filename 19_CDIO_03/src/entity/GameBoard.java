...
public class GameBoard {
	...
	field[12] = new Refuge("Walled City", 5000);// Name, bonus reward
	field[13] = new Refuge("Monastary", 500);// Name, bonus reward
	field[14] = new LaborCamp("Huts in the mountain", 2500);// Name and price
	field[15] = new LaborCamp("The pit", 2500);// Name and price
	field[16] = new Tax("Goldmine", 2000);//Name and tax
	field[17] = new Tax("Caravan", 4000);// Name and tax
