...
public class GameBoard {
	//Creates a Array with a size of 23
	Field[] fields = new Field[22]; 
	
	public GameBoard() {
	// Here we define the 21 fields with what name, rent and price			
	...
	fields[12] = new Refuge("Walled City", 5000);// Name, bonus reward
	fields[13] = new Refuge("Monastary", 500);// Name, bonus reward
	fields[14] = new LaborCamp("Huts in the mountain", 2500);// Name and price
	fields[15] = new LaborCamp("The pit", 2500);// Name and price
	fields[16] = new Tax("Goldmine", 2000);//Name and tax
	fields[17] = new Tax("Caravan", 4000);// Name and tax
